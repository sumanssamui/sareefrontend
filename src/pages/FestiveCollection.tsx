  ...
  return (
    <section className="featured-products py-8 md:py-12 lg:py-16">
      <div className="container mx-auto px-4 max-w-7xl flex flex-col lg:flex-row gap-8 lg:gap-12">
        {/* Sidebar Filter - Hidden on mobile/tablet, shown on lg+ */}
        <Filter />
        ...
        <div className="flex-1 w-full">
          <div className="section-header text-center mb-8 md:mb-12">
            ...
            <p className="mt-3 text-base md:text-lg text-gray-600">
              Celebrate the season with our finest festive sarees & drapes
            </p>
          </div>
      ...
      {/* Quick View Modal */}
      {selectedProduct && (
        <div className="modal-overlay fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4" onClick={closeModal}>
          <div
            className="modal-content bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto relative"
            onClick={(e) => e.stopPropagation()}
          >
            <button className="close-btn absolute top-4 right-4 text-3xl z-10" onClick={closeModal}>
              ✕
            </button>
            <div className="modal-body grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-10">
              ...
              <div className="modal-details flex flex-col justify-center">
                ...
                <p className="modal-desc mt-6 text-gray-700 leading-relaxed">
                  Celebrate in style with our exclusive {selectedProduct.name},
                  perfect for festive gatherings, weddings, and joyful occasions.
                  Crafted with elegance and rich texture for your special moments.
                </p>
