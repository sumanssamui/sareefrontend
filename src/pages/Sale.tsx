...
const products = [
  {
    ...
    originalPrice: 7999,
    discount: 38,
    image: 'https://images.pexels.com/photos/5341865/pexels-photo-5341865.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Bestseller',
    rating: 4.8,
  },
  {
    ...
    originalPrice: 9999,
    discount: 35,
    image: 'https://images.pexels.com/photos/6593898/pexels-photo-6593898.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'New',
    rating: 4.9,
  },
  {
    ...
    originalPrice: 12999,
    discount: 31,
    image: 'https://images.pexels.com/photos/6318922/pexels-photo-6318922.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Premium',
    rating: 5.0,
  },
  {
    ...
    originalPrice: 3999,
    discount: 38,
    image: 'https://images.pexels.com/photos/32515968/pexels-photo-32515968.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Trending',
    rating: 4.7,
  },
  {
    ...
    originalPrice: 11999,
    discount: 33,
    image: 'https://images.pexels.com/photos/18089329/pexels-photo-18089329.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Bestseller',
    rating: 4.9,
  },
  {
    ...
    originalPrice: 8499,
    discount: 35,
    image: 'https://images.pexels.com/photos/9226778/pexels-photo-9226778.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'New',
    rating: 4.8,
  },
  {
    ...
    originalPrice: 5999,
    discount: 42,
    image: 'https://images.pexels.com/photos/7123306/pexels-photo-7123306.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Sale',
    rating: 4.6,
  },
  {
    ...
    originalPrice: 6499,
    discount: 38,
    image: 'https://images.pexels.com/photos/14950358/pexels-photo-14950358.jpeg?auto=compress&cs=tinysrgb&w=600',
    tag: 'Trending',
    rating: 4.7,
  },
];
      ...
      <div className="container mx-auto px-4 max-w-7xl flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 w-full">
          <div className="section-header text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">SALE</h2>
            <p className="mt-3 text-base md:text-lg text-gray-600">
              Grab the best deals on handpicked sarees that define elegance and grace
            </p>
          </div>
            ...
            {products.map((product) => (
              <div key={product.id} className="product-card">
                <div className="product-image-wrapper relative overflow-hidden rounded-lg">
                  ...
                  <button
                    className={`wishlist-btn absolute top-2 right-2 ${wishlist.includes(product.id) ? 'active' : ''}`}
            ...
            <div className="modal-body grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-10">
              ...
              <div className="modal-details flex flex-col justify-center">
                ...
                <p className="modal-desc mt-6 text-gray-700 leading-relaxed">
                  Don't miss this limited-time sale offer! Premium quality{' '}
                  {selectedProduct.name} at an unbeatable price. Perfect blend of
                  tradition and style.
                </p>
